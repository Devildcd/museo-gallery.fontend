...
export class EditComponent {
  ...
  ngOnInit() {
    this.activeRoute.params
      ...
      .subscribe((contenido) => {
        ...
        console.log( contenido.imagenes );
      ...
      this.museoService.countEventosNoticiasPrincipales().subscribe(data => {
        ...
        console.log( this.cantEventosPrincipales );
        console.log( this.cantNoticiasPrincipales );
      });
  
      this.museoService.countVisitasPrincipales().subscribe( data => {
        this.cantVisitasPrincipales = data;
        console.log(this.cantVisitasPrincipales);
      } )
  }
  ...
  editContent() {
    ...
    if (id === undefined) {
      console.error("El ID del estudiante es undefined");
      return;
    }
  ...
  saveImages() {
    if (this.contenido.id === undefined || this.contenido.id === null) {
      console.error("El ID del contenido es undefined o null");
      return;
    }
